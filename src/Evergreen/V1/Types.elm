...
type alias DictPackageNameToElmPackageSummary =
    Dict.Dict String Evergreen.V1.Notebook.Types.ElmPackageSummary
...
type PopupState
    ...
    | ManualPopup
    | NewDataSetPopup
    | EditDataSetPopup Evergreen.V1.Notebook.DataSet.DataSetMetaData
    | SignUpPopup
    | PackageListPopup
    | NewNotebookPopup
    | StateEditorPopup
...
type alias FrontendModel =
    ...
    , publicDataSetMetaDataList : List Evergreen.V1.Notebook.DataSet.DataSetMetaData
    , privateDataSetMetaDataList : List Evergreen.V1.Notebook.DataSet.DataSetMetaData
    , evalState : Evergreen.V1.Notebook.Types.EvalState
    ...
    , books : List Evergreen.V1.Notebook.Book.Book
    , currentCell : Maybe Evergreen.V1.Notebook.Cell.Cell
    , cellInsertionDirection : Evergreen.V1.Notebook.Types.CellDirection
    , currentBook : Evergreen.V1.Notebook.Book.Book
    , cellContent : String
...
type alias NoteBookDict =
    Dict.Dict String Evergreen.V1.Notebook.Book.Book
...
type alias BackendModel =
    ...
    , dataSetLibrary : Dict.Dict String Evergreen.V1.Notebook.DataSet.DataSet
...
type FrontendMsg
    ...
    | GotElmJsonDict (Result Http.Error Evergreen.V1.Notebook.Types.ElmPackageSummary)
    | GotReply Evergreen.V1.Notebook.Cell.Cell (Result Http.Error String)
    | ReceivedFromJS String
    | AskToListDataSets DataSetDescription
    | AskToSaveDataSet Evergreen.V1.Notebook.DataSet.DataSetMetaData
    | AskToCreateDataSet
    | AskToDeleteDataSet Evergreen.V1.Notebook.DataSet.DataSetMetaData
    | SubmitPackageList
    | SubmitTest
    ...
    | ToggleCellLock Evergreen.V1.Notebook.Cell.Cell
    | ChangeCellInsertionDirection Evergreen.V1.Notebook.Types.CellDirection
    | NewCodeCell Evergreen.V1.Notebook.Cell.CellState Int
    | NewMarkdownCell Evergreen.V1.Notebook.Cell.CellState Int
    | DeleteCell Int
    | EditCell Evergreen.V1.Notebook.Cell.Cell
    | ClearCell Int
    | EvalCell Evergreen.V1.Notebook.Cell.CellState Int
    ...
    | Reset
    | TogglePublic
    | SetCurrentNotebook Evergreen.V1.Notebook.Book.Book
    | CloneNotebook
    | PullNotebook
    | ExportNotebook
...
type ToBackend
    ...
    | RunTask
    | SendUsers
    | DeleteDataSet Evergreen.V1.Notebook.DataSet.DataSetMetaData
    | SaveDataSet Evergreen.V1.Notebook.DataSet.DataSetMetaData
    | GetListOfDataSets DataSetDescription
    | CreateDataSet Evergreen.V1.Notebook.DataSet.DataSet
    ...
    | ImportNewBook String Evergreen.V1.Notebook.Book.Book
    | SaveNotebook Evergreen.V1.Notebook.Book.Book
    | DeleteNotebook Evergreen.V1.Notebook.Book.Book
    | GetPublicNotebook String
    | GetClonedNotebook String String
    | GetPulledNotebook String String String String
    | UpdateSlugDict Evergreen.V1.Notebook.Book.Book
    | GetUsersNotebooks String
    | GetPublicNotebooks (Maybe Evergreen.V1.Notebook.Book.Book) String
...
type ToFrontend
    ...
    | GotListOfPublicDataSets (List Evergreen.V1.Notebook.DataSet.DataSetMetaData)
    | GotListOfPrivateDataSets (List Evergreen.V1.Notebook.DataSet.DataSetMetaData)
    | GotData Int String Evergreen.V1.Notebook.DataSet.DataSet
    | GotDataForDownload Evergreen.V1.Notebook.DataSet.DataSet
    | GotUsersPackageDictInfo DictNoteBookIdsToElmPackageSummaryDict
    | GotNotebook Evergreen.V1.Notebook.Book.Book
    | GotPublicNotebook Evergreen.V1.Notebook.Book.Book
    | GotNotebooks (Maybe Evergreen.V1.Notebook.Book.Book) (List Evergreen.V1.Notebook.Book.Book)
    | SendMessage String
